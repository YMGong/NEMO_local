...
#ctrl_file_dir=/wrk/puotila/DONOTREMOVE/EC-Earth/ecearth3/trunk/runtime/classic/ctrl

# Tells where to find nemo executable
#nem_src_dir=${WRKDIR}/DONOTREMOVE/NEMOEXP
nem_src_dir=/wrk/puotila/DONOTREMOVE/EC-Earth/ecearth3/trunk/sources/nemo-3.6/CONFIG
# Architecture
