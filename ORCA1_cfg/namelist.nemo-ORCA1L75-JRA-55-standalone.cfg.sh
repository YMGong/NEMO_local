...
!              !             !  (if <0  months)  !   name   !   (logical)  !  (T/F) ! 'monthly' ! filename ! pairing  !
   sn_wndi     = 'uas'       ,         3         , 'uas'    ,   .true.     , .false.,  'yearly' , 'weights_JRA-55_orca1_bicubic.nc'  , 'Uwnd' 
   sn_wndj     = 'vas'       ,         3         , 'vas'    ,   .true.     , .false.,  'yearly' , 'weights_JRA-55_orca1_bicubic.nc'  , 'Vwnd' 
   sn_qsr      = 'rsds'      ,         3         , 'rsds'   ,   .true.     , .false.,  'yearly' , 'weights_JRA-55_orca1_bilinear.nc' , ''     
   sn_qlw      = 'rlds'      ,         3         , 'rlds'   ,   .true.     , .false.,  'yearly' , 'weights_JRA-55_orca1_bilinear.nc' , ''     
   sn_tair     = 'tas'       ,         3         , 'tas'    ,   .true.     , .false.,  'yearly' , 'weights_JRA-55_orca1_bilinear.nc' , ''    
   sn_humi     = 'huss'      ,         3         , 'huss'   ,   .true.     , .false.,  'yearly' , 'weights_JRA-55_orca1_bilinear.nc' , ''     
   sn_prec     = 'prra'      ,         3         , 'prra'   ,   .true.     , .false.,  'yearly' , 'weights_JRA-55_orca1_bilinear.nc' , ''    
   sn_snow     = 'prsn'      ,         3         , 'prsn'   ,   .true.     , .false.,  'yearly' , 'weights_JRA-55_orca1_bilinear.nc' , ''   
               !
