...
!              !             !  (if <0  months)  !   name   !   (logical)  !  (T/F) ! 'monthly' ! filename ! pairing  !
   sn_wndi     = 'u10'       ,         3         , 'u10'    ,   .true.     , .false.,  'yearly' , 'weights_DFS5.2_orca1_bicubic.nc'  , 'Uwnd' 
   sn_wndj     = 'v10'       ,         3         , 'v10'    ,   .true.     , .false.,  'yearly' , 'weights_DFS5.2_orca1_bicubic.nc'  , 'Vwnd' 
   sn_qsr      = 'radsw'     ,        24         , 'radsw'  ,   .true.     , .false.,  'yearly' , 'weights_DFS5.2_orca1_bilinear.nc' , ''     
   sn_qlw      = 'radlw'     ,        24         , 'radlw'  ,   .true.     , .false.,  'yearly' , 'weights_DFS5.2_orca1_bilinear.nc' , ''     
   sn_tair     = 't2'        ,         3         , 't2'     ,   .true.     , .false.,  'yearly' , 'weights_DFS5.2_orca1_bilinear.nc' , ''    
   sn_humi     = 'q2'        ,         3         , 'q2'     ,   .true.     , .false.,  'yearly' , 'weights_DFS5.2_orca1_bilinear.nc' , ''     
   sn_prec     = 'precip'    ,        24         , 'precip' ,   .true.     , .false.,  'yearly' , 'weights_DFS5.2_orca1_bilinear.nc' , ''    
   sn_snow     = 'snow'      ,        24         , 'snow'   ,   .true.     , .false.,  'yearly' , 'weights_DFS5.2_orca1_bilinear.nc' , ''   
               !
